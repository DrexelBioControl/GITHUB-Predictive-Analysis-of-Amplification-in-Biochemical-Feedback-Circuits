# ============================================================
# MODEL 1: active gate + fuel leak
#
# Biological assumption:
#   Leak occurs through the active/cleaved gate reacting with fuel:
#       RSDg + F -> OUT-like product
#
# Model name used in configs:
#   model1_active_gate_fuel
# ============================================================
...
def rhs(t, x, RSD_temp, IN_temp, F_temp, params):
    ...
    dRSDg = kRz*uRSDg - ksd*RSDg*IN + krev*I_RSDg*OUT - klkg*RSDg*F
    dIN = k_txn*IN_temp - ksd*RSDg*IN + krev*I_RSDg*OUT + kfsd*I_RSDg*F
    dOUT = ksd*RSDg*IN - kf_rep*OUT*DRL - krev*I_RSDg*OUT + klkg*RSDg*F + basal_frac*k_txn*RSD_temp
    dDRL = - kf_rep*OUT*DRL
    dROL = kf_rep*OUT*DRL
    dI_RSDg = ksd*RSDg*IN - krev*I_RSDg*OUT - kfsd*I_RSDg*F
    dF = k_txn*F_temp - kfsd*I_RSDg*F + kback*F_RSDg*IN - klkg*RSDg*F
    dF_RSDg = kfsd*I_RSDg*F - kback*F_RSDg*IN + klkg*RSDg*F
